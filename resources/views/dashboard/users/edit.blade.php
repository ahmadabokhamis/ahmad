                ...
                <div class="card mb-4 mt-4">
                  ...
                  {!! Form::model($user, ['method' => 'PATCH','route' => ['admin.users.update', $user->id]]) !!}
                            ...
                            <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="first_name" id="location" placeholder=""  value="{{$user->first_name}}"    />
                                  ...
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="last_name" id="location" placeholder=""  value="{{$user->last_name}}"    />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="user_name" id="basic-default-name" value="{{$user->user_name}}" />
