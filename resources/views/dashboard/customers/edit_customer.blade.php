                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="name" id="location" placeholder="" value="{{ $customer->name }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" name="email" id="location" placeholder="" value="{{ $customer->email }}" />
        ...
        $(document).ready(function() {
            ...
            $("#save_customer").on("click", function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/customers/update') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
