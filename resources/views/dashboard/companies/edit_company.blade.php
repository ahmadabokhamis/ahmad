                                    ...
                                    <div class="col-6" style="border-right: 1px #d9dee3 solid;">
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <textarea class="form-control" name="desciption">{{ $company->desciption }}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" id="address" name="address" id="location" placeholder="" value="{{ $company->address }}"   />
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" name="email" id="location" placeholder="" value="{{ $company->email }}" />
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" name="phone" id="location" placeholder="" value="{{ $company->phone }}" />
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" name="country" id="location" placeholder="" value="{{ $company->country }}" />
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" name="region" id="location" placeholder="" value="{{ $company->region }}" />
        ...
        $(document).ready(function() {
            ...
            $("#save_company").on("click", function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/companies/update') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
