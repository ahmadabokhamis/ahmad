@extends('Dashboard.layouts.master') @section('content')
                        ...
                        <div class="card mb-4">
                            <div class="row">
                                ...
                                <div class="col-4" style="align-self: center; text-align: center;">
                                    <button id="save_categories" class="btn btn-icon btn-primary"><i
                            ...
                            <div class="card-body">
                                ...
                                <form id="form" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control" placeholder="description" name="description" id="location" >{{ $category->description }}
                                        </textarea>
    ...
    <script>
        $(document).ready(function() {
            //////////////////////////////////////////////
            $("#save_categories").on("click", function(e) {
                e.preventDefault();
                var form = $("#form")[0];
