@extends('company.layouts.master') @section("content")
                    ...
                    <div class="card mb-4">
                        <div class="row">
                            ...
                            <div class="col-4" style="align-self: center; text-align: center;">
                                ...
                                <a href="{{ route('admin.categories') }}" class="btn btn-icon btn-outline-secondary"><i class="fa-solid fa-arrow-left"></i></a>
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select type="text" class="form-control" name="" id="location">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select type="text" class="form-select" name="driver_id" id="location">
