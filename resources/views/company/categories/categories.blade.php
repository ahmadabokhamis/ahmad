...
">
              <nav aria-label="breadcrumb" >
                    <ol class="breadcrumb breadcrumb-style1">
                      ...
                      <div class="col-3" style="align-self: center ;text-align: end">
                           ...
                           <a href="{{ route('company.categories.add') }}" type="submit" class=" btn btn-icon btn-primary">  <i class="fa-solid fa-plus"></i></a>
        ...
        <div class="card ">
            ...
            <div class="row">
                <div class="col-12">
                    <h5 class="card-header h"><i class="fa-solid fa-users"></i>  Categories list</h5>
                </div>
