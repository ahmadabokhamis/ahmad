                                    ...
                                    <div class="col-6" style="border-right: 1px #d9dee3 solid;">
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <select type="text" class="form-select" name="pickup"> </select>
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" name="tall" id="location" placeholder="" value="" />
                                                    <span class="text-danger error-text tall_error"></span>
                                                </div>
                                            </div>
                                        </div>
