                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="location">eamil</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="location">password time</label>
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" name="starting_time" id="location" placeholder="" value="" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" name="arrival_time" id="location" placeholder="" value="" />
