<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        {{ request()->route()->named('company.categories')? 'active open': '' }}
        {{ request()->route()->named('company.products')? 'active open': '' }}
            ">
        ...
        <ul class="menu-sub">
            <li class="menu-item {{ request()->route()->named('company.categories')? 'active': '' }}">
                <a href="{{ route('company.categories') }}" class="menu-link ">
                    <div data-i18n="Error">Categories</div>
                </a>
            </li>
            <li class="menu-item {{ request()->route()->named('company.products')? 'active': '' }}">
                <a href="{{ route('company.products') }}" class="menu-link ">
        ...
        {{ request()->route()->named('company.customers')? 'active open': '' }}
        ...
        ">
            ...
            <ul class="menu-sub ">
                <li class="menu-item {{ request()->route()->named('company.customers')? 'active': '' }}">
                    <a href="{{ route('company.customers') }}" class="menu-link">
        ...
        {{ request()->route()->named('company.orders')? 'active open': '' }}
        ...
        ">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->route()->named('admin.orders')? 'active': '' }}">
                    <a href="{{ route('company.orders') }}" class="menu-link">
        ...
        <li class="menu-item">
            <div class="menu-link ">
                <a href="{{ route('company.logout') }}" class="btn btn-sm btn-outline-danger" style="margin: auto"><i
