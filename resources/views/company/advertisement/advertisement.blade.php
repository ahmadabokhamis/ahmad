    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <div class="col-3" style="align-self: center ;text-align: end">
                ...
                <a href="{{ route('company.advertisement.add') }}" type="submit" class=" btn btn-icon btn-primary"> <i
        ...
        <div class="card ">
            ...
            <div class="row">
                <div class="col-12">
                    <h5 class="card-header h"><i class="fa-solid fa-users"></i> Products list</h5>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <form action="" method="POST">
                            @csrf
                            <!--<label for="nameSmall" class="form-label">are sure of the deleting process ?</label>-->
